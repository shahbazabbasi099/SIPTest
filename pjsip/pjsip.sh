...
BASE_DIR="$1"
PJSIP_VER="2.6"
PJSIP_URL="http://www.pjsip.org/release/$PJSIP_VER/pjproject-$PJSIP_VER.tar.bz2"
PJSIP_DIR="$1/src"
LIB_PATHS=("pjlib/lib" \
           "pjlib-util/lib" \
           "pjmedia/lib" \
...
function armv7() {
    export CFLAGS="-O2 -miphoneos-version-min=7.0"
    export LDFLAGS="-O2 -miphoneos-version-min=7.0"
    _build "armv7"
}
function armv7s() {
    export CFLAGS="-O2 -miphoneos-version-min=7.0"
